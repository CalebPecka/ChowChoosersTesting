...
public class TestReadReviews {
  ...
  public void testReadReviews() throws Exception {
    ...
    Thread.sleep(1500);
    driver.findElement(By.xpath("//div[@id='wrapper']/main/div/div[8]/div[2]/p")).click();
    Thread.sleep(1500);
    driver.findElement(By.xpath("//div[@id='wrapper']/main/div/div[7]/div[2]/p")).click();
  }
